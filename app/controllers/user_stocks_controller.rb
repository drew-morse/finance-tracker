class UserStocksController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_stock.save
        format.html { redirect_to my_portfolio_path, notice: 'Stock #{@user_stock.ticker} successfully added to portfolio' }
  ...
  def destroy
    @user_stock.destroy
    respond_to do |format|
      format.html { redirect_to my_portfolio_path, notice: 'Stock removed from portfolio' }
